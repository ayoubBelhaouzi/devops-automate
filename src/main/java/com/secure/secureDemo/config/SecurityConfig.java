...
public class SecurityConfig {
    ...
    public InMemoryUserDetailsManager inMemoryUserDetailsManager(){
       return new InMemoryUserDetailsManager(
               ...
               User.withUsername("user1").password("1234").authorities("USER").build(),
               User.withUsername("user2").password("1234").authorities("USER").build(),
               User.withUsername("admin").password("1234").authorities("USER","ADMIN").build()
       );
    }
